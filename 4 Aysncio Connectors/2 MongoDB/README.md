...
В отличие от asyncpg, в motor объектами библиотеки можно пользоваться из разных потоков, соответсвенно запускать несколько методов, используя `asyncio.gather`

Смотри `5_concurrent.py`
